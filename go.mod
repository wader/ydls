...
require (
	...
	github.com/wader/goutubedl v0.0.0-20200503165620-325c69594137
	...
	// bump: sync /golang.org\/x\/sync .*-(.*)/ gitrefs:https://github.com/golang/sync.git|re:%refs/heads/master%|@|/^(.{12})/
	golang.org/x/sync v0.0.0-20200317015054-6e8e738ad208
)
