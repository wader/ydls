...
HTTP service for [youtube-dlc](https://github.com/blackjack4494/yt-dlc) that downloads media from
...
Make sure you have ffmpeg, youtube-dlc, rtmpdump and mplayer
...
`URL` - Any URL that [youtube-dlc](https://github.com/blackjack4494/yt-dlc) can handle  
...
youtube-dlc URL can point to a plain media file.
...
When fiddling with ffmpeg and youtube-dlc related code I usually do this:
...
- Make download part into an interface to support more than youtube-dlc.
